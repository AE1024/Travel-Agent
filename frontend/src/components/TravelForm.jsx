...
const IATA_CITIES = {
  ...
  WAW:'Varşova',PRG:'Prag',BUD:'Budapeşte',ATH:'Atina',SKG:'Selanik',
  OTP:'Bükreş',SOF:'Sofya',BEG:'Belgrad',ZAG:'Zagreb',KRK:'Krakow',
  LYS:'Lyon',MRS:'Marsilya',NCE:'Nis',SVQ:'Sevilya',VLC:'Valensiya',AGP:'Malaga',
  MAN:'Manchester',EDI:'Edinburgh',DTM:'Dortmund',
...
const CITY_IATA = {
  ...
  'bucharest':'OTP','bükreş':'OTP','bukres':'OTP',
  'sofia':'SOF','sofya':'SOF',
  'belgrade':'BEG','belgrad':'BEG',
  'zagreb':'ZAG',
  'krakow':'KRK','krakof':'KRK',
  'lyon':'LYS',
  'marseille':'MRS','marsilya':'MRS','marseille':'MRS',
  'nice':'NCE','nis':'NCE',
  'seville':'SVQ','sevilla':'SVQ','sevilya':'SVQ',
  'valencia':'VLC','valensiya':'VLC',
  'malaga':'AGP','málaga':'AGP',
  'manchester':'MAN',
  'edinburgh':'EDI','edinburg':'EDI',
  'dortmund':'DTM',
